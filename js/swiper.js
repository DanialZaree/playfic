var Swiper = function () {
  ...
  function d(e, t) {
    ...
    return s.WebKitCSSMatrix
      ...
      : (n = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform ||
        l.transform ||
        l.getPropertyValue("transform").replace(
          "translate(",
          "matrix(1, 0, 0, 1,",
        ),
        a = n.toString().split(",")),
  ...
  function S(e, t, s) {
    ...
    return s
      ? e["width" === t ? "offsetWidth" : "offsetHeight"] +
        parseFloat(
          a.getComputedStyle(e, null).getPropertyValue(
  ...
  function M(e) {
    return (t) =>
      Math.abs(t) > 0 && e.browser && e.browser.need3dFix &&
        Math.abs(t) % 90 == 0
        ? t + .001
        : t;
  }
    ...
    return L || (L = function () {
      ...
      if (a()) {
        ...
        if (t.includes("Version/")) {
          const [e, a] = t.split("Version/")[1].split(" ")[0].split(".").map(
            (e) => Number(e),
          );
          s = e < 16 || 16 === e && a < 2;
        }
  ...
  var B = {
    updateSize: function () {
      ...
      t = void 0 !== e.params.width && null !== e.params.width
        ...
        (t = t - parseInt(b(a, "padding-left") || 0, 10) -
          parseInt(b(a, "padding-right") || 0, 10),
          s = s - parseInt(b(a, "padding-top") || 0, 10) -
    ...
    updateSlides: function () {
            ...
            s.centeredSlides
              ...
              : (s.roundLengths && (T = Math.floor(T)),
                (C - Math.min(e.params.slidesPerGroupSkip, C)) %
                      e.params.slidesPerGroup == 0 && m.push(T),
                h.push(T),
                T = T + L + x),
            e.virtualSize += L + x,
            M = L,
      ...
      if (
        e.virtualSize = Math.max(e.virtualSize, r) + w,
          n && l && ("slide" === s.effect || "coverflow" === s.effect) &&
      ...
      if (0 === m.length && (m = [0]), 0 !== x) {
        ...
        c.filter((e, t) => !(s.cssMode && !s.loop) || t !== c.length - 1)
          .forEach((e) => {
            e.style[t] = `${x}px`;
          });
      }
    ...
    updateClickedSlide: function (e, t) {
      ...
      !i && s.isElement && t && t.length > 1 && t.includes(e) &&
        [...t.slice(t.indexOf(e) + 1, t.length)].forEach((e) => {
          !i && e.matches && e.matches(`.${a.slideClass}, swiper-slide`) &&
            (i = e);
        });
      let r, n = !1;
      if (i) {
      ...
      s.clickedSlide = i,
        ...
        s.clickedIndex !== s.activeIndex && s.slideToClickedSlide();
    },
  };
  var N = {
    ...
    slidePrev: function (e, t, s) {
      ...
      if (
        ...
        (f = n.indexOf(h),
          ...
          "auto" === i.slidesPerView && 1 === i.slidesPerGroup &&
  ...
  function F(e) {
    ...
    } else {"touchstart" === i.type && 1 === i.targetTouches.length &&
    ...
    (w = !1, "SELECT" === p.nodeName && (n.isTouched = !1)),
      s.activeElement && s.activeElement.matches(n.focusableElements) &&
      s.activeElement !== p &&
      ("mouse" === i.pointerType ||
        "mouse" !== i.pointerType && !p.matches(n.focusableElements)) &&
      s.activeElement.blur();
    const b = w && t.allowTouchMove && l.touchStartPreventDefault;
    !l.touchStartForcePreventDefault && !b || p.isContentEditable ||
    i.preventDefault(),
      l.freeMode && l.freeMode.enabled && t.freeMode && t.animating &&
      !l.cssMode && t.freeMode.onTouchStart(),
      t.emit("touchStart", i);
  }
  function V(e) {
    const t = a(),
    ...
    if (
      t.activeElement && t.activeElement.matches(i.focusableElements) &&
      t.activeElement !== p.target && "mouse" !== p.pointerType &&
      t.activeElement.blur(),
        t.activeElement && p.target === t.activeElement &&
    ...
    if (!i.isMoved) {
      ...
      i.allowMomentumBounce = !1,
        !r.grabCursor || !0 !== s.allowSlideNext && !0 !== s.allowSlidePrev ||
        s.setGrabCursor(!0),
        s.emit("sliderFirstMove", p);
    }
    if (
      (new Date()).getTime(),
        i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b &&
        y && Math.abs(g) >= 1
    ) {
    ...
    if (
      r.touchReleaseOnEdges && (x = 0),
        g > 0
          ? (b && y && i.allowThresholdMove &&
            i.currentTranslate > (r.centeredSlides
        ...
        !s.allowSlideNext && "next" === s.swipeDirection &&
        i.currentTranslate < i.startTranslate &&
        (i.currentTranslate = i.startTranslate),
        !s.allowSlidePrev && "prev" === s.swipeDirection &&
        i.currentTranslate > i.startTranslate &&
        (i.currentTranslate = i.startTranslate),
  ...
  function _(e) {
    ...
    if (
      s.lastClickTime = o(),
        ...
        !s.isTouched || !s.isMoved || !t.swipeDirection ||
  ...
  function W() {
    ...
    !("auto" === t.slidesPerView || t.slidesPerView > 1) || !e.isEnd ||
      e.isBeginning || e.params.centeredSlides || l
      ? e.params.loop && !n
    ...
    t.enabled &&
      (t.allowClick ||
        (t.params.preventClicks && e.preventDefault(),
          t.params.preventClicksPropagation && t.animating &&
  ...
  function K(e) {
    ...
    D(t, e.target),
      t.params.cssMode ||
      "auto" !== t.params.slidesPerView && !t.params.autoHeight || t.update();
  }
  function Z() {
    const e = this;
  ...
  function te(e, t) {
    return function (s) {
      ...
      "object" == typeof i && null !== i
        ? (!0 === e[a] && (e[a] = { enabled: !0 }),
          "navigation" === a && e[a] && e[a].enabled && !e[a].prevEl &&
          !e[a].nextEl && (e[a].auto = !0),
          ["pagination", "scrollbar"].indexOf(a) >= 0 && e[a] && e[a].enabled &&
          !e[a].el && (e[a].auto = !0),
          a in e && "enabled" in i
            ? ("object" != typeof e[a] || "enabled" in e[a] ||
              (e[a].enabled = !0),
              e[a] || (e[a] = { enabled: !1 }),
              p(t, s))
            : p(t, s))
        ...
        unsetGrabCursor: function () {
          ...
          e.params.watchOverflow && e.isLocked || e.params.cssMode ||
            (e.isElement && (e.__preventObserver__ = !0),
              e["container" === e.params.touchEventsTarget ? "el" : "wrapperEl"]
                .style.cursor = "",
  ...
  class ie {
    ...
    update() {
      ...
      if (
        ...
        if (
          ("auto" === s.slidesPerView || s.slidesPerView > 1) && e.isEnd &&
          !s.centeredSlides
        ) {
    ...
    mount(e) {
      ...
      s.swiper = t,
        s.parentNode && s.parentNode.host &&
  ...
  const ge = [function (e) {
    ...
    function g(e) {
      ...
      } else {m = Math.abs(g.pixelX) > Math.abs(g.pixelY)
          ? -g.pixelX * h
          : -g.pixelY;}
      if (0 === m) return !0;
      r.invert && (m = -m);
        ...
        if (!a) {
          ...
          if (
            ...
            if (
              ...
              a.delta - e.delta >= 1 && e.delta <= 6
            ) {
              const s = m > 0 ? .8 : .2;
              c = e,
                u.splice(0),
                d = l(() => {
                  !t.destroyed && t.params &&
      ...
      return e && "string" == typeof e && t.isElement &&
        ...
        : (e &&
          ("string" == typeof e && (s = [...document.querySelectorAll(e)]),
            t.params.uniqueNavElements && "string" == typeof e && s &&
              s.length > 1 && 1 === t.el.querySelectorAll(e).length
    ...
    s({
      ...
      a("enable disable", () => {
        ...
        e = T(e),
          s = T(s),
          t.enabled ? l() : [...e, ...s].filter((e) => !!e).forEach(
            (e) => e.classList.add(t.params.navigation.lockClass),
          );
      }),
      a("click", (e, s) => {
        ...
        if (t.params.navigation.hideOnClick && !l) {
          ...
          a.length
            ...
            [...a, ...r].filter((e) => !!e).forEach(
              (e) => e.classList.toggle(t.params.navigation.hiddenClass),
            );
        }
      });
    const u = () => {
    ...
    function p() {
      ...
      if (
        t.params.loop
          ...
          "bullets" === s.type && t.pagination.bullets &&
    ...
    a("changeDirection", () => {
      ...
      a("click", (e, s) => {
        ...
        if (
          t.params.pagination.el && t.params.pagination.hideOnClick && r &&
          r.length > 0 && !a.classList.contains(t.params.pagination.bulletClass)
        ) {
          if (
            t.navigation &&
    ...
    function E(e) {
      ...
      let r;
      r = (y(e) - w(i)[t.isHorizontal() ? "left" : "top"] -
        (null !== d ? d : c / 2)) / (p - c),
    ...
    function P() {
      ...
      t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 &&
      1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)),
        i.length > 0 && (i = i[0]),
        ...
        t.isElement && o.push(...f(t.hostEl, i)),
          ...
          s.forEach((e, s) => {
            ...
            (l += Math.ceil(s / 2) - a * (n.length - 1)),
              ...
              e.querySelectorAll(`${i}, [data-swiper-parallax-rotate]`).forEach(
                (e) => {
                  r(e, l);
                },
              );
      ...
      i >= 0 && (u[i] = e),
        ...
        (o = !0,
          ...
          (a.scale = m.scaleMove / m.scaleStart * c,
            a.scale > m.maxRatio &&
            (a.scale = m.maxRatio - 1 + (a.scale - m.maxRatio + 1) ** .5),
            a.scale < s.minRatio &&
            (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** .5),
    ...
    function L(e) {
      if (
        !S(e) || !function (e) {
          ...
          return !!e.target.matches(s) ||
            [...t.hostEl.querySelectorAll(s)].filter(
    ...
    function w(e) {
      ...
      if (
        ...
        t.pagination && a.matches(ne(t.params.pagination.bulletClass)) &&
          a.click();
      }
    }
    function b() {
    ...
    const x = (e, t, s) => {
      ...
      L = () => {
        ...
        e.slideLabelMessage && t.slides.forEach((a, i) => {
          ...
          h(
            a,
            e.slideLabelMessage.replace(/\{\{index\}\}/, r + 1).replace(
              /\{\{slidesLength\}\}/,
              s,
            ),
          );
    ...
    let i = !1, n = {};
    const l = (e) =>
        e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(
          /--+/g,
          "-",
        ).replace(/^-+/, "").replace(/-+$/, ""),
      o = (e) => {
      ...
      hashNavigation: {
        ...
        getSlideIndex(e, s) {
          if (t.virtual && t.params.virtual.enabled) {
            const e = t.slides.filter((e) =>
              e.getAttribute("data-hash") === s
            )[0];
            if (!e) return 0;
    ...
    function d(e) {
      ...
      if (
        ...
        for (let e = 0; e < i; e += 1) {
          f(s.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`)
            .forEach((e) => {
              e.classList.add(r);
            });
        }
      } else {for (let e = 0; e < i; e += 1) {
      ...
      setTranslate: () => {
        ...
        for (let e = 0; e < a.length; e += 1) {
          ...
          s % 4 == 0
            ...
            l && (h = -h),
            u || (g = h, h = 0);
          const w = `rotateX(${c(u ? 0 : -r)}deg) rotateY(${
            c(u ? r : 0)
    ...
    ue({
      ...
      setTranslate: () => {
        ...
        for (let n = 0; n < e.length; n += 1) {
          ...
          const h = `translate3d(${u}px, ${m}px, 0px) rotateX(${
            r(p)
          }deg) rotateY(${r(c)}deg)`;
        ...
        setTranslate: () => {
          ...
          for (let e = 0, t = a.length; e < t; e += 1) {
            ...
            Math.abs(w) < .001 && (w = 0),
              ...
              Math.abs(h) < .001 && (h = 0),
              Math.abs(b) < .001 && (b = 0);
            const y = `translate3d(${w}px,${v}px,${f}px)  rotateX(${
              p(h)
    ...
    ue({
      ...
      setTranslate: () => {
        ...
        for (let s = 0; s < e.length; s += 1) {
          ...
          const v = m.join(", "),
            w = `rotateX(${o(h[0])}deg) rotateY(${o(h[1])}deg) rotateZ(${
              o(h[2])
            }deg)`,
            b = p < 0
